 ...
 *   assistant message -> ✓ 通过 (green flash) | ◐ 未完交付 (yellow flash)
 *                        | ✗ <拒绝词> (red flash)
 */
  ...
  factory: (require) => {
    ...
    function ArmorDock(props) {
      ...
      var armor = typeof useProjection === "function"
        ? useProjection("armor")
        : undefined;
      // v0.4.3 修复：busy 态改读运行时 turnBoundary 投影（openTurnStartSeq 非空 = 真在跑）。
      // armor 折叠的 running 在回合无正文收尾（中止/报错/空回复）时会永久卡 true——徽标假忙。
      var turnBoundary;
      try {
        turnBoundary = typeof useProjection === "function"
          ? useProjection("turnBoundary")
          : undefined;
      } catch (e) {
      ...
      return react.createElement(
        ...
        react.createElement(
          "div",
          { style: badgeStyle, "data-armor": "gen4", title: "无限四代 · 破甲插件已生效 · 实时状态" },
