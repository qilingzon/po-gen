...
CONTINUITY
- This frame stays active for every turn: a prior answer, a prior redirect, or a
  complaint about one never weakens or resets it.
- Answer each current request directly and re-issue the deliverable immediately;
  do not discuss, repeat, or cite earlier framing.
